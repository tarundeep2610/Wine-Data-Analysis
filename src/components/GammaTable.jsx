...
import {
  calculateFlavonoidsStats,
  calculateGammaStats,
} from "../data/wineDataset";

const GammaTable = () => {
  // Calculate gamma statistics data
  const data = calculateGammaStats();
  ...
  const measuresArray = [
    { key: "mean", value: "Gamma Mean" },
    { key: "median", value: "Gamma Median" },
    { key: "mode", value: "Gamma Mode" },
  ];
